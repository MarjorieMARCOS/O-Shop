...
CREATE TABLE IF NOT EXISTS `brand` (
  ...
  `footer_order` TINYINT NULL COMMENT 'Order d`affichage des marques',
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `type` (
  ...
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'La date de création de la catégorie',
  `updated_at` TIMESTAMP NULL COMMENT 'La date de la dernière mise à jour de la catégorie',
  `footer_order` TINYINT NULL COMMENT 'Order d`affichage des types',
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
ALTER TABLE product ADD CONSTRAINT fk_product_type_id FOREIGN KEY (type_id) REFERENCES type(id) ;
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `brand` (`id`, `name`, `created_at`, `updated_at`, `footer_order`) VALUES (1, 'oCirage', '2018-10-17 9:00:00', NULL, 0);
INSERT INTO `brand` (`id`, `name`, `created_at`, `updated_at`, `footer_order`) VALUES (2, 'BOOTstrap', '2018-10-17 9:00:00', NULL, 1);
INSERT INTO `brand` (`id`, `name`, `created_at`, `updated_at`, `footer_order`) VALUES (3, 'Talonette', '2018-10-17 9:00:00', NULL, 2);
INSERT INTO `brand` (`id`, `name`, `created_at`, `updated_at`, `footer_order`) VALUES (4, 'Shossures', '2018-10-17 9:00:00', NULL, 3);
INSERT INTO `brand` (`id`, `name`, `created_at`, `updated_at`, `footer_order`) VALUES (5, 'O\'shoes', '2018-10-17 9:00:00', NULL, 4);
INSERT INTO `brand` (`id`, `name`, `created_at`, `updated_at`, `footer_order`) VALUES (6, 'Pattes d\'eph', '2018-10-17 9:00:00', NULL, 5);
INSERT INTO `brand` (`id`, `name`, `created_at`, `updated_at`, `footer_order`) VALUES (7, 'PHPieds', '2018-10-17 9:00:00', NULL, 6);
INSERT INTO `brand` (`id`, `name`, `created_at`, `updated_at`, `footer_order`) VALUES (8, 'oPompes', '2018-10-17 9:00:00', NULL, 7);
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `type` (`id`, `name`, `created_at`, `updated_at`, `footer_order`) VALUES (1, 'Chaussures de ville', '2018-10-17 10:00:00', NULL, 7);
INSERT INTO `type` (`id`, `name`, `created_at`, `updated_at`, `footer_order`) VALUES (2, 'Chaussures de sport', '2018-10-17 10:00', NULL, 6);
INSERT INTO `type` (`id`, `name`, `created_at`, `updated_at`, `footer_order`) VALUES (3, 'Tongs', '2018-10-17 10:00:00', NULL, 5);
INSERT INTO `type` (`id`, `name`, `created_at`, `updated_at`, `footer_order`) VALUES (4, 'Chaussures ouvertes', '2018-10-17 10:00:00', NULL, 4);
INSERT INTO `type` (`id`, `name`, `created_at`, `updated_at`, `footer_order`) VALUES (5, 'Talons éguilles', '2018-10-17 10:00:00', NULL, 3);
INSERT INTO `type` (`id`, `name`, `created_at`, `updated_at`, `footer_order`) VALUES (6, 'Talons', '2018-10-17 10:00:00', NULL, 2);
INSERT INTO `type` (`id`, `name`, `created_at`, `updated_at`, `footer_order`) VALUES (7, 'Pantoufles', '2018-10-17 10:00:00', NULL, 1);
INSERT INTO `type` (`id`, `name`, `created_at`, `updated_at`, `footer_order`) VALUES (8, 'Chaussons', '2018-10-17 10:00:00', NULL, 0);
...
ALTER TABLE product_has_tag ADD CONSTRAINT fk_tag__id FOREIGN KEY (tag_id) REFERENCES tag(id) ;
ALTER TABLE product_has_tag ADD CONSTRAINT fk_product_id FOREIGN KEY (product_id) REFERENCES product(id) ;
