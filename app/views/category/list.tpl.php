		...
		<tbody>
			<?php foreach ($categoryList as $category) : ?>
				...
				<tr>
					...
					<td class="w-25"><?= $category->getName(); ?></td>
					<td class="w-25"><?= $category->getSubtitle(); ?></td>
					...
					<td class="text-end">
						...
						<div class="btn-group">
							...
							<div class="dropdown-menu">
								<a class="dropdown-item" href="<?= $router->generate('category-delete', ['id' => $category->getId()]); ?>?tokenCSRF=<?= $tokenCSRF; ?>">Oui,
									je veux supprimer</a>
