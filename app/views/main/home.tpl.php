<?php
$limitListCategory = $viewData['limitListCategory'];
$limitListProduct = $viewData['limitListProduct'];
...
<div class="container my-4">
				...
				<div class="card text-white mb-3">
					...
					<div class="card-body">
						<table class="table table-striped table-hover">
							...
							<tbody>
								<?php foreach($limitListCategory as $category):  ?>
									<tr>
				...
				<div class="card text-white mb-3">
					...
					<div class="card-body">
						<table class="table table-striped table-hover">
							...
							<tbody>
								<?php foreach($limitListProduct as $product) :  ?>
									<tr>
	...
	</div> <!-- And for every user interaction, we import Bootstrap JS and popper JS components -->
